...
<div style="width:100%; font-size:14px; color:#e8f2fd; padding:10px 0px 10px 0px; text-align:center; background:#143d69">Da click sobre el nombre del servidor publico y descubre mas ...</div>
<hr class="line"> 
<div class="gen_content"><div class="gen_par">Servidor Publico Comisionado:</div><div class="gen_dato"><a href="servidor.php?correo=<?php echo $correo;?>&id=" target="_parent"><?php echo utf8_encode($nombre)?></a></div></div>
<div class="gen_content"><div class="gen_par">Cargo:</div><div class="gen_dato"><?php echo utf8_encode($cargo)?></div></div>
